...
const handleVideoFileUpload = async (videofile) => {
  ...
  return (
    <div className="mx-auto p-6 bg-white shadow-md font-montserrat">
      <h2 className="text-3xl font-semibold mb-4 text-center text-gray-900">Project Information</h2>
      <p className='text-center text-orange-400'>Information Shared here will be publicly accessible</p>
      <form className='flex justify-center flex-col flex-wrap gap-2 md:gap-5 w-11/12 md:w-1/2 mx-auto p-2 md:p-10' onSubmit={handleProjectSubmit} encType='multipart/form-data'>
            <div className='flex flex-col gap-1'>
                ...
                <input className='rounded-md p-1 border' placeholder='Project Name' id='ProjectName' name='ProjectName' onChange={handleProjectChange}></input>
            </div>
            <div className="mb-4 col-span-3">
              <label className="block mb-1 text-gray-800">Project Logo</label>
              <input type="file" accept="image/*" id="Projectlogo" name="Projectlogo" onChange={(e) => setimagefile(e.target.files[0])} className="w-full p-1 border rounded-md text-gray-800" />
            </div>
            <div className='flex flex-col gap-1'>
                <div className='text-gray-800'>Email Address</div>
                <input type="email" id="OfficialMail" name="OfficialMail" className='rounded-md p-1 border' onChange={handleProjectChange} placeholder='Email ID'></input>
            </div>
            <div className='flex flex-col gap-1'>
                <div className='text-gray-800'>Valuation <span className='opacity-40'>{`(Indian Rupees)`}</span></div>
                <input type="number" id="Valuation" name="Valuation" className='rounded-md p-1 border-2' onChange={handleProjectChange} placeholder='Minimum 100000 Valuation' min="100000"></input>
            </div>

            <div>
              <label className="block mb-1 text-gray-800">Previous 3 Years Sales Stats <span className='opacity-40'>{`(Indian Rupees)`}</span></label>
                <div className="max-w-screen-lg mx-auto rounded-lg ">
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      <div className="mb-4">
                        <label className="block mb-1 text-gray-800">{currentYear}</label>
                      ...
                      <div className="mb-4">
                        <label className="block mb-1 text-gray-800">{currentYear-1}</label>
                      ...
                      <div className="mb-4">
                        <label className="block mb-1 text-gray-800">{currentYear-2}</label>
            ...
            <div className='text-gray-800'>List Your Major Stakeholders</div>
                  <div className="w-full max-w-md">
                    <div className="flex items-center border-b-2 border-gray-500 py-2">
                      ...
                      />
                      <button
                        className="flex-shrink-0 bg-gray-700 hover:bg-gray-800 border-gray-700 hover:border-gray-700 text-sm border-4 text-gray-800 py-1 px-2 rounded"
                        type="button"
            ...
            <div className='text-gray-800 m-1'>Unique Selling Proposition</div>    
            <textarea
            ...
            <div className="mb-4 col-span-3">
              <label className="block mb-1 text-gray-800">Video Pitch</label>
              <input type="file" accept="video/*" name="VideoPitch" id="VideoPitch" onChange={(e) => setvideofile(e.target.files[0])} className="w-full p-1 border rounded-md text-gray-800" />
            </div>

            <div className='text-gray-800 mt-4'>Describe Your Vision</div>    
            <textarea
              className="resize-none border rounded-md mt-2 focus:outline-none focus:ring focus:border-blue-300 w-full py-2 px-3 text-gray-700 leading-normal"
              rows={4} // Initial height of 4 rows
              placeholder="Enter your text here..."
            ...
            <div className='flex flex-row flex-wrap justify-left gap-2 md:gap-9'>
              <div>
                <div className='text-gray-800 mt-4 flex flex-col'>Password <span className='text-sm opacity-50'>(Must be Atleast 8 Characters)</span></div>    
              ...
              <div>
                <div className='text-gray-800 mt-4 flex flex-col'>Confirm Password <span className='text-sm opacity-50'>(Must be Same as Password)</span></div>    
