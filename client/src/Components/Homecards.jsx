function Homecards(props) {
  return (
    <div className="hover: border-solid prserve-3d w-full">
        <div className="p-2 w-[200px] h-[230px] md:w-[400px] md:h-[320px] rounded-2xl overflow-hidden shadow-lg bg-gradient-to-t from-red-300 to-orange-400 text-white group perspective">
